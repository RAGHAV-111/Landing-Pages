      ...
      <footer className="footer-1 bg-gray-100 py-8 sm:py-12 ">
        <div className="container mx-auto px-4 ">
          <div className="sm:flex sm:flex-wrap sm:-mx-6 md:py-4 ">
            ...
            <div className="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6 mx-6  ">
            ...
            <div className="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 sm:mt-0 mx-6  ">
            ...
            <div className="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 md:mt-0  mx-6">
            ...
            <div className="px-4 mt-4 sm:w-1/3 xl:w-1/6 sm:mx-auto xl:mt-0 xl:ml-auto  mx-6">
          ...
          <div className="sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t ">
            <div className="sm:w-full px-4 md:w-1/6  mx-6">
              <strong>FWR</strong>
            </div>
            <div className="px-4 sm:w-1/2 md:w-1/4 mt-4 md:mt-0 mx-6">
